...
class CropsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crop" do
    assert_difference('Crop.count') do
      post crops_url, params: { crop: { amount: @crop.amount, cost: @crop.cost, name: @crop.name } }
    end
  ...
  test "should update crop" do
    patch crop_url(@crop), params: { crop: { amount: @crop.amount, cost: @crop.cost, name: @crop.name } }
