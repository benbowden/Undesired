...
class ProducesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produce" do
    assert_difference('Produce.count') do
      post produces_url, params: { produce: { amount: @produce.amount, cost: @produce.cost, name: @produce.name } }
    end
  ...
  test "should update produce" do
    patch produce_url(@produce), params: { produce: { amount: @produce.amount, cost: @produce.cost, name: @produce.name } }
